 ...
 */
package com.github.bakuplayz.cropclick.latest.autofarms;
...
public final class Container implements ContainerComponent {
    ...
    public ContainerComponent of(@NotNull Block block) {
        ...
        if (state instanceof ShulkerBox) {
            return new Container(((ShulkerBox) state).getInventory());
        }

        // TODO: Add version check before this is evaluated...
