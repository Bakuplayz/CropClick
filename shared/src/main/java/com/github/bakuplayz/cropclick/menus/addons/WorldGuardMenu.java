...
import com.github.bakuplayz.cropclick.addons.WorldGuardAddon;
...
public final class WorldGuardMenu extends AbstractAddonMenu {
    ...
    private final class ToggleItem extends AbstractToggleItem {
        ...
        protected String getName() {
            return ADDON_GUARD_ITEM_NAME.get(plugin, MessageUtils.getStatusMessage(plugin, getState().isAddonEnabled()));
        }
