 ...
 */
@Getter
public final class OfflineGrowthAddon extends AbstractAddon {

    public final static String NAME = "OfflineGrowth";

    @Nullable
    private OfflineGrowthFunctionality functionality;
    ...
    public void setup() {
        if (isInstalled()) {
            this.functionality = new OfflineGrowthFunctionality();
        }
    }
