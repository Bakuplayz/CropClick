...
public final class LocationTypeAdapter implements JsonSerializer<Location>, JsonDeserializer<Location> {
    ...
    @NotNull
    @Override
    public Location deserialize(@NotNull JsonElement element, Type type, JsonDeserializationContext context)
     ...
     */
    @NotNull
    private DoublyLocation deserializeDoublyLocation(@NotNull JsonElement element) {
     ...
     */
    @NotNull
    private Location deserializeLocation(@NotNull JsonElement element) {
        JsonObject body = element.getAsJsonObject();
        World world = Bukkit.getWorld(body.get("world").getAsString());
        return new Location(
