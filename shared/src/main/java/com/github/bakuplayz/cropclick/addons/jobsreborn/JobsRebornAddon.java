 ...
 */
@Getter
public final class JobsRebornAddon extends AbstractAddon {

    public final static String NAME = "Jobs";

    private JobsRebornFunctionality functionality;
    ...
    public void setup() {
        if (isInstalled()) {
            this.functionality = new JobsRebornFunctionality(cropsConfig);
        }
    }
