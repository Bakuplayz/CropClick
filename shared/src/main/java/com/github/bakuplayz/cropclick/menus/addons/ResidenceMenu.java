...
import com.github.bakuplayz.cropclick.addons.ResidenceAddon;
...
public final class ResidenceMenu extends AbstractAddonMenu {
    ...
    private final class ToggleItem extends AbstractToggleItem {
        ...
        protected String getName() {
            return ADDON_RESIDENCE_ITEM_NAME.get(plugin, MessageUtils.getStatusMessage(plugin, getState().isAddonEnabled()));
        }
