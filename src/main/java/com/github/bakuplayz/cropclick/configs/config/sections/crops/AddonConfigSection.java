...
public final class AddonConfigSection extends ConfigSection {
     ...
     */
    public void setMcMMOExperience(@NotNull String cropName, int experience) {
     ...
     */
    public int getJobsPoints(@NotNull String cropName) {
        return config.getInt("crops." + cropName + ".addons.jobsReborn.points", 0);
    }
     ...
     */
    public void setJobsPoints(@NotNull String cropName, int points) {
     ...
     */
    public int getJobsMoney(@NotNull String cropName) {
        return config.getInt("crops." + cropName + ".addons.jobsReborn.money", 0);
    }
     ...
     */
    public void setJobsMoney(@NotNull String cropName, int money) {
     ...
     */
    public int getJobsExperience(@NotNull String cropName) {
        return config.getInt("crops." + cropName + ".addons.jobsReborn.experience", 0);
    }
     ...
     * @param experience the experience to set.
     */
    public void setJobsExperience(@NotNull String cropName, int experience) {
    ...
    /**
     * Gets the {@link AuraSkillsAddon Aurelium} experience for the {@link Crop provided crop}.
     *
     * @param cropName the name of the crop.
     * @return the Aurelium experience for the crop.
     */
    public int getSkillsExperience(@NotNull String cropName) {
        return config.getInt("crops." + cropName + ".addons.auraSkills.experience", 0);
    }


    /**
     * Sets the {@link AuraSkillsAddon Aurelium} experience for the {@link Crop provided crop} to the provided experience.
     *
     * @param cropName   the name of the crop.
     * @param experience the experience to set.
     */
    public void setSkillsExperience(@NotNull String cropName, int experience) {
        config.set("crops." + cropName + ".addons.auraSkills.experience", experience);
        cropsConfig.saveConfig();
    }
